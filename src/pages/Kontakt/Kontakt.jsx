                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                                ...
                                <p className="text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2">
                                    Udfyld formularen for at starte en samtale
                                </p>
                                ...
                                <div className="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                                    ...
                                    <div className="ml-4 text-md tracking-wide font-semibold w-40">
                                        Leo-Lov Inc, Vestervænget 232, 30.sal 6574 Øster Nørup, Danmark
                                    </div>
                                </div>
                            ...
                            <form className="p-6 flex flex-col justify-center">
                                ...
                                <button type="submit" className="md:w-32 bg-secondary hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300">
                                    Submit
                                </button>
                            </form>
                        </div>
