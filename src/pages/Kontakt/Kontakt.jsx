          ...
          <div className="mt-8 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <form className="p-6 flex flex-col justify-center" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="md:w-32 bg-secondary hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300"
                >
                  Submit
                </button>
              </form>
